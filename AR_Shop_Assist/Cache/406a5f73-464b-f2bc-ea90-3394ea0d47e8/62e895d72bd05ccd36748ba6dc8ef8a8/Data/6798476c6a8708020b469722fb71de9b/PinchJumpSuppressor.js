...
class PinchJumpSuppressor {
    ...
    applyDirectionLowpassFilter(direction) {
        ...
        if (this.deltaMode === DeltaMode.MEASURE) {
            ...
            if (this.verboseMode) {
                this.log.d("directionDelta: " + this.directionDelta.angle.toFixed(3) + ",  " + this.directionDelta.axis.toString());
            }
        }
    ...
    updateSuppressionState() {
        ...
        if (this.verboseMode) {
            this.log.d("lastActivationTimestampInSecond: " + ((_a = this.lastActivationTimestampInSecond) === null || _a === void 0 ? void 0 : _a.toFixed(2)));
            this.log.d("lastDeactivationTimestampInSecond: " + ((_b = this.lastDeactivationTimestampInSecond) === null || _b === void 0 ? void 0 : _b.toFixed(2)));
        }
    }
    /**
