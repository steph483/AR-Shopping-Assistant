...
let SyncInteractor = (() => {
    ...
    var SyncInteractor = _classThis = class extends _classSuper {
        ...
        get isHoveringCurrentInteractable() {
            ...
            return (_b = (_a = this.interactorState.hoveredInteractables) === null || _a === void 0 ? void 0 : _a.includes(this.currentInteractable)) !== null && _b !== void 0 ? _b : false;
        }
        ...
        isHoveringInteractable(interactable) {
            var _a, _b;
            return (_b = (_a = this.interactorState.hoveredInteractables) === null || _a === void 0 ? void 0 : _a.includes(interactable)) !== null && _b !== void 0 ? _b : false;
        }
        /**
