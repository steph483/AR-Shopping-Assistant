...
#endif
sc_writeFragData0(max(l9_511,vec4(0.0)));
return;
}
vec4 l9_513;
#if (sc_ProjectiveShadowsCaster)
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_543-0.0039215689)),min(1.0,l9_543+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
sc_writeFragData0(vec4(packValue(l9_545),packValue(l9_545),packValue(l9_545),packValue(l9_545)));
}
#endif
}
#else
...
sc_writeFragData0(l9_542);
}
#endif
}
#else
{
sc_writeFragData0(l9_541);
}
#endif
}
#endif
