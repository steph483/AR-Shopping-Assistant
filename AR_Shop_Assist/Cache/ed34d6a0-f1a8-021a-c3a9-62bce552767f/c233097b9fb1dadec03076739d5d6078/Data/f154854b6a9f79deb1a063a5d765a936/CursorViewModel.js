...
class CursorViewModel {
    ...
    setupStateMachine() {
        ...
        this.stateMachine.addState({
            ...
            onUpdate: () => {
                ...
                const targetingPosition = (_e = this.getTargetingPointCursorPosition(hitPosition)) !== null && _e !== void 0 ? _e : hitPosition;
                this.updateIndirectCursorPosition((_g = (_f = this.interactor) === null || _f === void 0 ? void 0 : _f.interactionStrength) !== null && _g !== void 0 ? _g : null, targetingPosition);
            },
            transitions: [
                {
                    nextStateName: CursorState.Inactive,
                ...
                },
                {
                    ...
                    checkOnUpdate: () => {
                        var _a, _b, _c;
                        return (((_a = this.interactor) === null || _a === void 0 ? void 0 : _a.currentTrigger) !== Interactor_1.InteractorTriggerType.None && ((_c = (_b = this.scrollView) === null || _b === void 0 ? void 0 : _b.isDragging) !== null && _c !== void 0 ? _c : false));
                    }
                }
            ],
            onExit: () => {
    ...
    getTargetingPointCursorPosition(hitPointPosition) {
        ...
        const targetingPosition = (_a = this.getFarFieldCursorPosition()) !== null && _a !== void 0 ? _a : hitPointPosition;
        if (isTriggering && !wasTriggering) {
            ...
            const initialHold = this.useHitPosition &&
                !(hitPointPosition.distance(targetingPosition) >= 2 || !((_b = this.interactor) === null || _b === void 0 ? void 0 : _b.isHoveringCurrentInteractable));
        ...
        return !((_d = (_c = this.interactor) === null || _c === void 0 ? void 0 : _c.currentInteractable) === null || _d === void 0 ? void 0 : _d.keepHoverOnTrigger)
