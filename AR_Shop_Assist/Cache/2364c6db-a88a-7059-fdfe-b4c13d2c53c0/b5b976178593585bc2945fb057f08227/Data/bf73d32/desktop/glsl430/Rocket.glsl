...
#endif
sc_writeFragData0(max(l9_181,vec4(0.0)));
return;
}
vec4 l9_183;
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_213-0.0039215689)),min(1.0,l9_213+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
sc_writeFragData0(vec4(packValue(l9_215),packValue(l9_215),packValue(l9_215),packValue(l9_215)));
}
#endif
}
#else
