...
let InteractableManipulation = (() => {
    ...
    var InteractableManipulation = _classThis = class extends _classSuper {
        ...
        updateStartTransform() {
            ...
            if (((_a = this.state.stateMachine.currentState) === null || _a === void 0 ? void 0 : _a.name) === this.state.states.Idle) {
                return;
            }
        ...
        getRayPosition(interactor) {
            ...
            const distanceToTarget = (_c = this.rayDistanceMap.get(interactor)) !== null && _c !== void 0 ? _c : 0;
        ...
        calculateStretchFactor(interactor) {
            ...
            const currDistance = (_b = this.rayDistanceMap.get(interactor)) !== null && _b !== void 0 ? _b : 0;
