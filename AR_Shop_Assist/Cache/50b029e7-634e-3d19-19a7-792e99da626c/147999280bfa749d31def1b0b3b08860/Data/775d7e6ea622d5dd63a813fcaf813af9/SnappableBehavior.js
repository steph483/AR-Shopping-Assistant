...
class SnappableBehavior {
    ...
    constructor(options) {
        ...
        this.frameTransform = (_a = this.frame.getFrameObject()) === null || _a === void 0 ? void 0 : _a.getTransform();
        ...
        this.onTriggerRelease = (e) => {
            ...
            if (this.isActive && !this.isScaling && this.isEnabled) {
                ...
                if (!isNull(this.ghost))
                    this.ghost.enabled = false;
                if (this.itemSnappingRange && !this.isTweening && ((_b = this.parent) === null || _b === void 0 ? void 0 : _b.getParent()) !== this.snapTo) {
                    this.setTweening(true);
                    this.itemSnappingRange = false;
                    (_c = this.parent) === null || _c === void 0 ? void 0 : _c.setParentPreserveWorldTransform(this.snapTo);
                    const startPosition = ((_d = this.parentTransform) === null || _d === void 0 ? void 0 : _d.getLocalPosition()) || vec3.zero();
                    (0, animate_1.default)({
                    ...
                    const startRot = ((_e = this.parentTransform) === null || _e === void 0 ? void 0 : _e.getWorldRotation()) || quat.quatIdentity();
                    ...
                    this.setTweening(true);
                    this.worldSnappingRange = false;
                    const startPosition = (_f = this.parentTransform) === null || _f === void 0 ? void 0 : _f.getWorldPosition();
