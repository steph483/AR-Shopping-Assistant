...
class CursorViewModel {
    ...
    constructor(interactor, parentSceneObject) {
        ...
        this.segmentLength = (_a = interactor.maxRaycastDistance) !== null && _a !== void 0 ? _a : this.segmentLength;
    ...
    executeCurrentStateLogic(frameData) {
        ...
        const currentStateName = (_a = this.cursorStateMachine.currentState) === null || _a === void 0 ? void 0 : _a.name;
        if (this.debugDrawEnabled) {
    ...
    handleStickyTriggerState(isTriggering, segmentStart, rayDir) {
        ...
        let planeIntersect = (_a = sticky.lastIntersect) !== null && _a !== void 0 ? _a : latchedWorld;
    ...
    handleActiveScrollDrag(segmentStart, rayDir, isTriggering) {
        ...
        if (this.context.scrollingView && this.context.scrollHitLocal && this.context.scrollPlaneNormal) {
            ...
            this.stableAnchorPoint = this._cursorPosition;
            const visualInteractable = (_a = this.interactor.currentInteractable) !== null && _a !== void 0 ? _a : this.context.scrollingView.getSceneObject().getComponent(Interactable_1.Interactable.getTypeName());
            const targetingVisual = visualInteractable && !isNull(visualInteractable.sceneObject)
                ? this.getEffectiveTargetingVisual(visualInteractable)
                : Interactable_1.TargetingVisual.None;
            const cursorAlpha = targetingVisual === Interactable_1.TargetingVisual.Cursor ? 1.0 : 0.0;
    ...
    getInteractionRay() {
        ...
        const length = (_a = this.interactor.maxRaycastDistance) !== null && _a !== void 0 ? _a : this.segmentLength;
    ...
    updateConeCollider(segmentStart, rayVector) {
        var _a;
        const desiredLength = (_a = this.interactor.maxRaycastDistance) !== null && _a !== void 0 ? _a : this.segmentLength;
        const coneShape = this.coneCollider.shape;
    ...
    initializeConeCollider(parent) {
        ...
        coneShape.length = (_a = this.interactor.maxRaycastDistance) !== null && _a !== void 0 ? _a : this.segmentLength;
