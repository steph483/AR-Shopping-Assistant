    ...
    var InteractorCursor = _classThis = class extends _classSuper {
        constructor() {
            ...
            this.onCursorUpdateV2 = (viewStateV2) => {
                ...
                const isHovering = ((_a = this.interactor) === null || _a === void 0 ? void 0 : _a.targetHitInfo) !== null;
                if (isHovering) {
                ...
                const interactionStrength = (_c = (_b = this.interactor) === null || _b === void 0 ? void 0 : _b.interactionStrength) !== null && _c !== void 0 ? _c : 0;
